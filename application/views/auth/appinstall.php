...
<body>
  ...
  <main class="container" role="main">
    ...
    <form method="GET" action="<?php echo base_url(); ?>Auth/check_login">
      <input id="shop" name="shop" autofocus="autofocus" placeholder="example.myshopify.com" class="marketing-input" type="text">
